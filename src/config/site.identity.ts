export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'vipfamilylife',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Vipfamilylife',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'vipfamilylife.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://vipfamilylife.com',

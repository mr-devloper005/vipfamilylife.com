...
export const pagesContent = {
  home: {
    metadata: {
      title: 'Magazine-style stories, profiles, and listings',
      description: 'Discover practical reads, profiles, listings, and visual stories in a clean editorial layout.',
      openGraphTitle: 'Magazine-style stories, profiles, and listings',
      openGraphDescription: 'Browse fresh reads, business profiles, and classified-style posts through a polished editorial homepage.',
      keywords: ['editorial stories', 'business profiles', 'classified posts', 'magazine layout'],
    },
    hero: {
      badge: 'Featured stories and business finds',
      title: ['Fresh ideas, standout profiles,', 'and practical posts worth opening.'],
      description: 'Explore articles, profiles, and classified-style updates in a homepage built like a clean online magazine.',
      primaryCta: { label: 'Start browsing', href: '/article' },
      secondaryCta: { label: 'Explore listings', href: '/listing' },
      searchPlaceholder: 'Search stories, services, profiles, and more',
      focusLabel: 'Highlights',
      featureCardBadge: 'editor picks',
      featureCardTitle: 'A softer editorial system for daily discovery.',
      featureCardDescription: 'Recent posts stay visible through a balanced mix of featured, compact, and image-led cards.',
    },
    intro: {
    ...
    cta: {
      badge: 'Ready to explore more',
      title: 'Keep reading, compare offers, or discover the next helpful profile.',
      description: 'The site stays easy to scan whether you are here for fresh reading, service discovery, or opportunity-led browsing.',
